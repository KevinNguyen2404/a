export const USERS_MESSAGES = {
  ...
  NAME_IS_REQUIRED: 'Name is required and cannot be a space',
  ...
  PASSWORD_NO_SPACE_MARK: 'Password no space and mark',
  ...
  CONFIRM_PASSWORD_NO_SPACE: 'Confirm password no space',
